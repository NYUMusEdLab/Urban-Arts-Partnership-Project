...
ancient_civil = [{:keyword=>"Savage", :word_class=>"noun", :definition=>"A person who is not under human control and lacks the restraints that are normal to civilized human beings."}, {:keyword=>"Civilized", :word_class=>"adjective", :definition=>"Polite and respectful. Marked by well-organized laws and rules about how people behave with each other."}, {:keyword=>"Centralize", :word_class=>"adjective", :definition=>"To focus the goals of a group of peoples by placing power and authority in one leader or central organization. "}, {:keyword=>"Social class", :word_class=>"noun", :definition=>"A group of people having the same social, economic, or educational status."}, {:keyword=>"Labor", :word_class=>"noun", :definition=>"Physical or mental work. "}, {:keyword=>"Specialized", :word_class=>"adjective", :definition=>"Made or used for one particular purpose, job, place, etc."}, {:keyword=>"Hunters and gatherers", :word_class=>"noun", :definition=>"In the earliest nomadic societies, the roles of people were broken into whether they would obtain food by killing animals as hunters or work as gatherers to collect fruit, nuts or eggs."}, {:keyword=>"Domestic animals", :word_class=>"noun", :definition=>"Any animal that depends on humans for food, water or shelter. This includes pets such as cats and dogs, as well as farm animals such as cattle, horses, goats and chickens. "}, {:keyword=>"Surplus", :word_class=>"noun", :definition=>"An amount (such as an amount of money or goods) that is more than the amount that is needed."}, {:keyword=>"Neolithic Revolution", :word_class=>"noun", :definition=>"A non-violent revolution in which human cultures transitioned from a nomadic lifestyle to one of farming and settlement. This allowed for populations to increase and for cities and empires to grow. "}, {:keyword=>"Traditional Societies", :word_class=>"noun", :definition=>"A society that holds firm to the beliefs, customs, habits and rituals of the past. "}, {:keyword=>"Farming", :word_class=>"noun", :definition=>"The business of running a farm."}, {:keyword=>"Subsitence", :word_class=>"noun", :definition=>"IS THIS REFERRING TO SUBSITENCE AGRICULTURE??? IF SO\\'85A self-sufficiency farming in which the farmers focus on growing enough food to feed themselves and their families. "}, {:keyword=>"Barter systems", :word_class=>"noun", :definition=>"A system of exchange by which goods or services are paid for by using other goods or services as one might use money."}, {:keyword=>"Osiris", :word_class=>"noun", :definition=>"The Egyptian god of the afterlife and the dead. "}, {:keyword=>"Droughts", :word_class=>"noun", :definition=>"Prolonged periods of dryness that prevent the growth of crops.  "}, {:keyword=>"Bantu Migration", :word_class=>"noun", :definition=>"One of the largest human relocations in history, in which about 60 million people from west and equatorial Africa, gradually moved south between 1000 and 1800 AD to accommodate a growing population."}, {:keyword=>"Babylon", :word_class=>"noun", :definition=>"The most famous city of ancient Mesopotamia whose ruins lie in what is now modern day Iraq.  "}, {:keyword=>"Hammurabi 2s Code", :word_class=>"noun", :definition=>"A Babylonian law of ancient Mesopotamia, dating back to 1754 BC, which was enacted by the Babylonian king, Hammurabi. The Code consists of 282 laws with descriptions of punishments such as \\'93an eye for an eye, a tooth for a tooth.\\'94  "}, {:keyword=>"Astronomy", :word_class=>"noun", :definition=>"The study of objects and matter outside the earth's atmosphere and of their physical and chemical properties."}, {:keyword=>"Socrates Plato and Aristotle", :word_class=>"noun", :definition=>"Three Greek philosophers, whose studies of ideas about truth, knowledge, nature and the meaning of life, who laid the foundations for how we perceive all of these complicated concepts.  "}, {:keyword=>"City states", :word_class=>"noun", :definition=>"A state that has its own government and consists of a city and the area around it."}, {:keyword=>"Democracy", :word_class=>"noun", :definition=>"A form of government in which people choose leaders by voting."}, {:keyword=>"Athens", :word_class=>"noun", :definition=>"An ancient city-state of Greece and one of the world's oldest cities. It was home to many of the most influential Greek philosophers and a center for the arts, learning and architecture. It is considered to be the birthplace of democracy. "}, {:keyword=>"Sparta", :word_class=>"noun", :definition=>"An ancient Greek city-state that emerged around 10th century BC and rose to become the dominant military power in ancient Greece, as its social system and constitution centered around military training. "}, {:keyword=>"Military state", :word_class=>"noun", :definition=>"A condition in which territory is under the effective control of a foreign armed force."}, {:keyword=>"Alexander the Great", :word_class=>"noun", :definition=>"King of the ancient Greek kingdom of Macedon from 336 to 323 BC. During his reign, he unified Greece, reestablished the Corinthian League and conquered the Persian Empire. "}, {:keyword=>"Hellenistic", :word_class=>"adjective", :definition=>"Of or relating to Greek history, culture, or art after the reign of Alexander the Great. "}, {:keyword=>"Twelve Tables", :word_class=>"noun", :definition=>"The ancient legislation that stood at the foundation of Roman law."}, {:keyword=>"Pax Romana", :word_class=>"noun", :definition=>"The Latin phrase for \\'93Roman peace.\\'94 This was a long period of relative peace and minimal expansion by military forces, lasting 206 years (27 BC to 180 AD).  "}, {:keyword=>"Emperor Justinian", :word_class=>"noun", :definition=>"A Byzantine emperor who ruled from 527 to 565 and sought to revive the Roman empire's greatness and reconquer the lost western half of the Roman Empire."}, {:keyword=>"Byzantine", :word_class=>"noun", :definition=>"The eastern portion of the Roman Empire, considered to be the most powerful economic, cultural and military force in Europe during the Middle Ages, until it fell to the Ottoman Turks in 1453. Its capital city was Constantinople (modern-day Istanbul), originally founded under the name Byzantium. "}, {:keyword=>"Constantinople", :word_class=>"noun", :definition=>"Named after the emperor, Constantine the Great, Constantinople was the capital city of the Roman and Byzantine empires and later the Latin and Ottoman empires. Was renamed Istanbul 1923, becoming the capital of modern day Turkey. "}, {:keyword=>"Middle Ages", :word_class=>"noun", :definition=>"Also known as the Medieval Period, a period of time between the 5th and 15th century, beginning with the collapse of the Western Roman Empire. This is the middle period of the three traditional divisions of Western history, preceded by Antiquity and followed by the Modern period."}] 

geography = [{:keyword=>"Rogue", :word_class=>"noun", :definition=>"A person who causes trouble in a playful way."}, {:keyword=>"Geography", :word_class=>"noun", :definition=>"1. An area of study that deals with the location of countries, cities, rivers, mountains, lakes, etc.2. The natural features (such as rivers, mountains, etc.) of a place."}, {:keyword=>"Adapt", :word_class=>"verb", :definition=>"To change your behavior so that it's easier to live in a particular place or situation."}, {:keyword=>"Physical feature", :word_class=>"noun", :definition=>"A natural structure or characteristic of a place or person. "}, {:keyword=>"Limited resources", :word_class=>"noun", :definition=>"An insufficient amount of supplies to fulfill all human wants and needs."}, {:keyword=>"In demand", :word_class=>"adjective", :definition=>"Greatly desired or sought after."}, {:keyword=>"Population", :word_class=>"noun", :definition=>"The number of people who live in a place."}, {:keyword=>"Topography", :word_class=>"noun", :definition=>"1. The art of making maps.2. The physical features (like mountains or rivers) of an area of land."}, {:keyword=>"Isolate", :word_class=>"verb", :definition=>"To put or keep someone or something in a place or situation that is separate from others."}, {:keyword=>"Harbor", :word_class=>"noun", :definition=>"A part of a body of water that is next to land and that is protected and deep enough to provide safety for ships."}, {:keyword=>"Economy", :word_class=>"noun", :definition=>"The process or system by which goods and services are produced, sold, and bought in a country or region."}, {:keyword=>"Climate", :word_class=>"noun", :definition=>"The usual weather conditions in a particular place."}, {:keyword=>"Civilization", :word_class=>"noun", :definition=>"A well-organized society where there is a high level of cultural and technological development. "}, {:keyword=>"River Valleys", :word_class=>"noun", :definition=>"The lands surrounding a river that frequently floods, over time, creating the perfect conditions for farming and raising livestock. Our world's first civilizations sprang from the river valleys of Africa and Asia."}, {:keyword=>"Tigris and Euphrates", :word_class=>"noun", :definition=>"Two massive rivers in the western part of Asia that formed the Fertile Crescent, the cradle of civilization. "}, {:keyword=>"Mesopotamia", :word_class=>"noun", :definition=>"The region between the Tigris and Euphrates rivers, which would become the greater part of modern Iraq. Some 10,000 years ago, some of the world's earliest civilizations, including the Sumerians and Babylonians, began in these lands. "}, {:keyword=>"Middle East", :word_class=>"noun", :definition=>"An unofficial term for the geographic region where Africa, Europe and Asia meet. Usually includes Iran, Iraq, Egypt, Jordan, Israel, Lebanon, and Syria and the countries of the Arabian Peninsula. Afghanistan, Libya, Turkey, and Sudan are sometimes also included."}, {:keyword=>"Fertile Crescent", :word_class=>"noun", :definition=>"A curved region of fertile land in the Middle East, stretching from the Mediterranean Sea to the Persian Gulf. Settlements of farmers in the Fertile Crescent can be dated back to c. 8000 BC and this area was home to some of the world's earliest known peoples, including Sumerians, Assyrians, Babylonians, and Phoenicians."}, {:keyword=>"Nile River", :word_class=>"noun", :definition=>"A major river in northeastern Africa, that flows through 11 countries and is generally regarded as the longest river in the world. The Nile, and the rich soils surrounding it, played a huge role in the founding of ancient Egyptian civilization."}, {:keyword=>"Yellow River", :word_class=>"noun", :definition=>"Also known as the Huang He, the Yellow River is the third longest river in Asia and was the birthplace of ancient Chinese civilization. "}, {:keyword=>"Fertile", :word_class=>"adjective", :definition=>"Able to support the growth of many plants or crops."}, {:keyword=>"Indus", :word_class=>"noun", :definition=>"A major river in Asia which flows through Pakistan, northwestern India and China."}, {:keyword=>"Arid", :word_class=>"adjective", :definition=>"Very dry, having very little rain or water."}, {:keyword=>"Erosion", :word_class=>"noun", :definition=>"The slow destruction of something by natural forces (such as water, wind, or ice). The process by which something becomes worn away."}, {:keyword=>"Badlands", :word_class=>"noun", :definition=>"A dry region where the land has been extensively eroded by water and wind. Characterized by steep slopes, deep canyons and minimal vegetation and often difficult to navigate by foot."}, {:keyword=>"Prairies", :word_class=>"noun", :definition=>"Large flat areas of land, mostly found in North America, that have few trees and are covered in grass."}, {:keyword=>"Savannahs", :word_class=>"noun", :definition=>"Large flat areas of land with grass and very few trees, found mainly in Africa and South America."}, {:keyword=>"Slash and burn farming", :word_class=>"noun", :definition=>"A type of farming done by cutting down and burning trees and plants in order to clear an area of land for growing crops."}, {:keyword=>"Tropics", :word_class=>"noun", :definition=>"The part of the world that is near the equator, where the weather is very warm."}, {:keyword=>"Atlas", :word_class=>"noun", :definition=>"A bound collection of maps that often including illustrations or informative tables. "}, {:keyword=>"Irregular coastlines", :word_class=>"noun", :definition=>"The land near a seashore that has deep enough waters that it is safe for ships to anchor very close to the coastline. "}, {:keyword=>"Warm water port", :word_class=>"noun", :definition=>"An area for ships to dock where the water does not freeze in winter time, making it possible for ships to load and unload supplies year round."}, {:keyword=>"Peninsulas", :word_class=>"noun", :definition=>"Pieces of land that are almost entirely surrounded by water yet are still attached to a larger land mass."}, {:keyword=>"Confined", :word_class=>"adjective", :definition=>"Forced to keep within certain limits or kept in a particular place."}, {:keyword=>"Archipelago", :word_class=>"noun", :definition=>"A group of islands."}, {:keyword=>"Isthmus", :word_class=>"noun", :definition=>"A thin strip of land that connects two larger land areas."}, {:keyword=>"Landmass", :word_class=>"noun", :definition=>"A very large area of land, such as a continent."}, {:keyword=>"Incas", :word_class=>"noun", :definition=>"A group of South American Indians who ruled an empire largely based in what is now modern day Peru, beginning in 13th century AD. The Inca were highly organized and built impressive roadways, irrigation systems and temples throughout the Andes. They were overthrown in 1532 by the Spanish conquistadores."}, {:keyword=>"Terrace Farming", :word_class=>"noun", :definition=>"Originally developed by the Inca, this is a type of farming in which canals are dug into the earth around crops to direct the flow of water into dry areas that need it most."}, {:keyword=>"Scarce", :word_class=>"adjective", :definition=>"Not plentiful or abundant."}, {:keyword=>"Irrigation", :word_class=>"noun", :definition=>"The watering of land by artificial means to maintain or increase the growth of food crops."}]
...
ancient_civil.each do |x|
  Song.find_by(:title=> "Ancient Civilizations").keywords.create(name: x[:keyword],
                                                    definition: x[:definition],
                                                    word_class: x[:word_class])
end